...
public interface ContentServiceHelper {
    ...
    /**
     * Login a user with the trusted client role
     *
     * @param responseReceiver  Response callback result
     * @param requestId         Identifier for the call
     * @param queryLogin        Parameters needed for the request
     ...
     * @return true if no error in the process of executing this method. Note that this does not mean whether or not the request was a success.
     */
    boolean authenticateAsTrustedClient(ResponseReceiverEmpty responseReceiver, String requestId, QueryLogin queryLogin, boolean shouldUseCache,
                                        List<View> viewsToDisable, OnRequestListener onRequestListener);

    /**
     * Set the trusted client role to the current logged in user
     *
     * @param responseReceiver  Response callback result
     * @param requestId         Identifier for the call
     * @param shouldUseCache    Indicator to use cache or not
     ...
     * @return true if no error in the process of executing this method. Note that this does not mean whether or not the request was a success.
     */
    boolean setTrustedClientRoleForUser(ResponseReceiverEmpty responseReceiver, String requestId, boolean shouldUseCache,
                                        List<View> viewsToDisable, OnRequestListener onRequestListener);
     ...
     * @return true if no error in the process of executing this method. Note that this does not mean whether or not the request was a success.
     */
    boolean setTrustedClientRoleForGuest(ResponseReceiverEmpty responseReceiver, String requestId, boolean shouldUseCache,
                                         List<View> viewsToDisable, OnRequestListener onRequestListener);
